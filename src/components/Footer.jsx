...
const Footer = () => {
  return (
  <div 
      className="  bg-[#222222] bg-cover  pb-12"
    >
    <div className=' flex  flex-col lg:flex-row max-w-[600px] px-6 lg:pl-8 md:max-w-[760px] lg:max-w-[1400px] 3xl:max-w-[2000px] m-auto  3xl:justify-between  lg:justify-around pt-16 pb-10'>
        <div className=' max-w-[700px] lg:max-w-[470px] sl:max-w-[500px] 3xl:max-w-[700px] text-white  font-sans font-light'>
          <a href="/" className=' flex items-center gap-4'>
            ...
            <h1 className=' text-white text-2xl lg:text-3xl 3xl:text-5xl'>APICAL DESIGNS</h1>
          </a>
          <p className=' pt-4 3xl:text-3xl'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Reiciendis modi labore et sequi autem est voluptates vel dicta? Cumque, earum odio vero laboriosam hic accusantium? Temporibus in perferendis praesentium nemo.</p>
        </div>
        <div className=' grid   md:grid-cols-2 3xl:grid-cols-3  gap-10 pt-10 3xl:pt-20'>
          <div className=' text-white'>
            ...
            <ul className='  space-y-2 '>
              <li className=' flex gap-3 items-center 3xl:text-2xl'><BsFillTelephoneFill></BsFillTelephoneFill>08096920127</li>
              <li className=' flex gap-3 items-center 3xl:text-2xl'><CgMail></CgMail> <p>Apicaldesign40@gmail.com</p></li>
              <li className=' flex gap-3 items-center 3xl:text-2xl'><FaLocationArrow></FaLocationArrow> <p>No 16 Ayanbode Street Oke-ira <br /> Ogba, Lagos</p></li>
            </ul>
          </div>
          <div className=' text-white'>
            <h2 className=' pb-3 text-xl 3xl:text-3xl 3xl:pb-6'>Our Services</h2>
            <ul className=' space-y-2 '>
              <li className=' 3xl:text-2xl '><a href="/">Architectural Design</a></li>
              <li className=' 3xl:text-2xl '><a href="/">Interior Design</a></li>
              <li className=' 3xl:text-2xl '><a href="/">Visualization</a></li>
              <li className=' 3xl:text-2xl '><a href="/">Building Construction</a></li>
            </ul>
          </div>
          <div className=' text-white'>
            <h2 className=' pb-3 text-xl 3xl:text-3xl 3xl:pb-6'>Quick Links</h2>
            <ul className=' space-y-2'>
              <li className=' 3xl:text-2xl'><a href="/">Privacy Policy</a></li>
              <li className=' 3xl:text-2xl'><a href="/">Terms & Conditions</a></li>
              <li className=' 3xl:text-2xl'><a href="/">Faqs</a></li>
              <li className=' 3xl:text-2xl'><a href="/">Cookies</a></li>
            </ul>
          </div>
        </div>
    </div>
