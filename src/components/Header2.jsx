      ...
      <nav className="    ">
        <div
          ...
          className={`py-2 w-full  fixed    border-[#333333] z-10 ${
            backgroundColor === "#222222" ? " shadow-none " : " shadow-lg"
          } `}
        >
            ...
            <div
              className={` flex justify-between   items-center ${
                backgroundColor === "transparent"
                  ? " border-b border-white pb-3 "
                  : " border-none pb-0"
              } `}
            >
              <div
                className={`  ${
                  backgroundColor === "#222222" ? "text-white" : "text-black"
                }`}
              >
              ...
              <div className="   hidden lg:block  ">
                ...
                >
                  ...
                  >
                    <li
                      className={`3xl:text-4xl   py-1 px-2 rounded  ${
                      ...
                      <div className=" flex items-center justify-between px-6">
                        <div className=" ">
                          <a href="/" className="flex items-center gap-2">
                            <img
                              src={`${
                                backgroundColor === "transparent" ? pic1 : pic7
                              }`}
                              alt=""
                              className=" w-8"
                            />
