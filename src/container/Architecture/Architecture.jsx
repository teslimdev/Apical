    ...
    <div>
      ...
      <section>
        <div className=" relative">
          <div
            style={{ backgroundImage: `url(${pic3})` }}
            className=" min-h-[240vh] md:min-h-[140vh] lg:min-h-screen bg-cover bg-center relative bg-fixed"
          >
            <div className=" absolute bg-white inset-0 top-0 opacity-50"></div>
          </div>
          <div className=" flex justify-center">
            <div className=" absolute top-20 lg:top-32">
              ...
              <div className=" grid md:grid-cols-2 lg:grid-cols-4 max-w-fit m-auto gap-6 md:gap-12 sl:gap-24 pt-8">
                <div className=" max-w-[200px] text-center">
                  <h2 className=" max-w-[200px] min-h-[200px] flex items-center justify-center rounded-full text-[4rem] bg-[#222222] text-white">
                    85%
                  </h2>
        ...
        <div className=" relative">
          ...
          <div className="  lg:max-w-[1200px] m-auto px-6 sl:px-0">
            <div className=" text-center lg:text-start  absolute text-white top-32">
              <div>
              ...
              <div className=" pt-8">
                <button className=" border border-white py-2 px-7 hover:bg-black hover:text-white">
                  {" "}
                  Read More
                </button>
              </div>
       ...
       <section>
        <div className=" relative">
          ...
          <div className="  lg:max-w-[1200px] flex justify-center lg:justify-end   m-auto ">
            <div className=" text-center lg:text-end  absolute top-32 lg:top-40  px-6 sl:px-0 ">
              <div className="   relative  ">
              ...
              <div className=" pt-8">
                <button className=" border border-black py-2 px-7 hover:bg-white hover:text-black">
                  {" "}
                  Read More
                </button>
              </div>
