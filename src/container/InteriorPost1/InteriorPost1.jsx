        ...
        <div  className=' pb-16'>
           <div className=' max-w-[1200px] m-auto px-6 sl:px-0'> 
            <div>
              ...
              <h3 className=' pt-3 pb-6'>At the heart of our design philosophy lies the belief that architecture is more than just structures; it's a reflection of the way we live, work, and interact with the world around us. Our team of seasoned professionals brings together a wealth of experience, passion, and a keen eye for detail to craft spaces that are not only aesthetically pleasing but also functionally efficient.</h3>
            </div>
             <div className=' pb-6'>
              <h2 className=' text-2xl  '>Creative Solutions:</h2>
              <h3 className=' py-3'>Innovation is the cornerstone of our practice. We understand that every project is unique, presenting its own set of challenges and opportunities. Our team thrives on pushing the boundaries of conventional design, constantly seeking fresh perspectives to create bespoke solutions tailored to your specific needs.</h3>
              <h3 className=' '>From concept to completion, we approach each project with a commitment to excellence, incorporating the latest trends and technologies to ensure that your space is not just relevant today but stands the test of time.</h3>
             </div>
              <div> 
                <h2 className=' text-2xl  '>Professional Designers:</h2>
                <h3 className=' py-3'>Our designers are not just architects; they are visionaries with a deep understanding of the evolving architectural landscape. With a wealth of experience across various sectors, our professionals bring a holistic approach to each project. Collaborative by nature, our team works closely with clients, ensuring that your vision is not only realized but enhanced through our expertise.</h3>
                <h3 className=''>We believe in the power of collaboration, and our designers are adept at seamlessly integrating your aspirations with their creative prowess. The result is a harmonious blend of functionality, aesthetics, and sustainability, creating spaces that inspire and endure.</h3>
              </div>
           </div>
        </div>
      </section>
      <section className=' bg-[#f2f2f2]'>
        <div className=' pb-12'>
          ...
          <div className=' max-w-[1200px] m-auto  px-6 sl:px-0 md:py-6'>
            <h3>Join us on a journey where creativity knows no bounds and professional excellence is the standard. Explore the potential of your space with "Creative Solutions by Professional Designers" at Apical Designs. Elevate your surroundings, elevate your lifestyle.</h3>
          </div>
        </div>
      </section>
      <section className="">
